...
目前会把所有输入图片转成640*640格式，尚不支持图片原本尺寸
...
1.current_path指process_xml.py工作的路径，可以直接在YOLOv5根路径下执行，也可以在根路径下新建文件夹在文件夹内执行
2.需要txt格式标签文件
...
# ================================ 参数 ================================
dict_classes = {'0': 'gangster', '1': 'police', '2': 'head'}  # 类别映射，类别信息来自yaml文件
# =====================================================================
...
# 读取txt文件
for i in os.listdir('raw/labels_txt'):
    ...
    if not os.path.exists('raw/labels_xml'):
        os.makedirs('raw/labels_xml')
